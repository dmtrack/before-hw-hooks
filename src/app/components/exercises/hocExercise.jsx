...
import withAuthAndButtons from "./withAuthAndButtons";
import withFunctions from "./withFunctions";
import SimpleComponent from "../examples/hoc/SimpleComponent";

const HocExercise = () => {
    const ComponentWithAuthAndButtons = withAuthAndButtons(SimpleComponent);
    const ComponentWithFunctionsAndStyles = withFunctions(SimpleComponent);
    ...
    return (
        <CollapseWrapper title="Упражнение">
            ...
            <CardWrapper>
                <SmallTitle>
                    5. Exercise 1: HOC with auth and buttons
                </SmallTitle>
                <ComponentWithAuthAndButtons />
            </CardWrapper>
            <CardWrapper>
                <SmallTitle>
                    6. Exercise 2: HOC with functions and styles
                </SmallTitle>
                <ComponentWithFunctionsAndStyles />
            </CardWrapper>
        </CollapseWrapper>
    );
};
